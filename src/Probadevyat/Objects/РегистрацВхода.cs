...
namespace IIS.Probadevyat
{
    ...
    public class РегистрацВхода : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadevyat.Комната fКомната;
        
        private IIS.Probadevyat.DetailArrayOfВходГостя fВходГостя;
        
        private IIS.Probadevyat.DetailArrayOfВходСотрудника fВходСотрудника;
        ...
        [PropertyStorage(new string[] {
                "Комната"})]
        [NotNull()]
        public virtual IIS.Probadevyat.Комната Комната
        {
            get
            {
                ...
                IIS.Probadevyat.Комната result = this.fКомната;
        ...
        public virtual IIS.Probadevyat.DetailArrayOfВходГостя ВходГостя
        {
            get
            {
                ...
                {
                    this.fВходГостя = new IIS.Probadevyat.DetailArrayOfВходГостя(this);
                }
                IIS.Probadevyat.DetailArrayOfВходГостя result = this.fВходГостя;
        ...
        public virtual IIS.Probadevyat.DetailArrayOfВходСотрудника ВходСотрудника
        {
            get
            {
                ...
                {
                    this.fВходСотрудника = new IIS.Probadevyat.DetailArrayOfВходСотрудника(this);
                }
                IIS.Probadevyat.DetailArrayOfВходСотрудника result = this.fВходСотрудника;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрацВходаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрацВходаE", typeof(IIS.Probadevyat.РегистрацВхода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистрацВходаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрацВходаL", typeof(IIS.Probadevyat.РегистрацВхода));
                }
            }
        }
    }
