...
namespace IIS.Probadevyat
{
    ...
    [View("СотрудникE", new string[] {
            ...
            "Должности.Карта.КодКарты as \'Номер карты\'"}, Hidden=new string[] {
            "Должности.Должность"})]
    ...
    [View("СотрудникL", new string[] {
            ...
            "Телефон as \'Телефон\'",
            "Должности.Должность as \'Должность\'",
            "Должности.Карта.КодКарты as \'Номер карты\'"})]
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadevyat.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Probadevyat.Должности Должности
        {
            get
            {
                ...
                IIS.Probadevyat.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Probadevyat.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Probadevyat.Сотрудник));
                }
            }
        }
    }
