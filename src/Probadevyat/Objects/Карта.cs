...
namespace IIS.Probadevyat
{
    ...
    [MasterViewDefineAttribute("КартаE", "Комната", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерКомнаты")]
    ...
    public class Карта : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadevyat.ВидКарты fТипКарты;
        ...
        public virtual IIS.Probadevyat.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Probadevyat.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаE", typeof(IIS.Probadevyat.Карта));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаL", typeof(IIS.Probadevyat.Карта));
                }
            }
        }
    }
